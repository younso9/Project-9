// This is used to create an express app
const express = require('express');
const app = express();

// Here we import the Sequelize module to use Sequelize. Allows us to chain logical statements together
const Sequelize = require('sequelize');

//Body-parser module analyzes the JSON, buffer, string and URL encoded data submitted using HTTP POST request.
const bodyParser = require('body-parser');
app.use(bodyParser.json()); //tells the system that you want json to be used.

// app.use(bodyParser.urlencoded({ extended: true }));
// tells the system whether you want to use a simple algorithm for shallow parsing (i.e. false) or complex algorithm 
// for deep parsing that can deal with nested objects(i.e.true).

// Sequelize DB object typical way to maps db entries to objects and vice versa
